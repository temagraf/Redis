...
- расположения в быстром кеше данных, к которым выполняется чаще всего запросов;
- экономии аппаратных ресурсов БД;
- сглаживания бустов трафика во время пиковых нагрузок.
